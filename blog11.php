            ...
            <div class="page-banner ovbl-dark" style="background-image:url(assets/images/banner/banner2.jpg);">
                <div class="container">
                    <div class="page-banner-entry">
                        <h1 class="text-white">Q&A with Dr. Barbara Oakley on teaching and learning tips</h1>
                    </div>
                </div>
            </div>
            <!-- Breadcrumb row -->
...
$sql = $pdo->prepare("SELECT bt, bd, bdes FROM bcard");
    $sql->execute();
    foreach($sql as $res){

  
                           echo '     <div class="recent-news blog-lg">
                                    ...
                                    <div class="info-bx">
                                        ...
                                        <h5 class="post-title"><a href="#">Learn and earn more information about this subject.</a></h5>
                                        <h1>'.$res['bt'].'</h1><br>
                                        <p>'.$res['bdes'].'
                                        </p>';
                                          }
                                ...
                                <div class="clearfix m-b20">
                                    ...
                                    <ol class="comment-list">
                                        ...
                                        <li class="comment">
                                            <div class="comment-body">
                                                <div class="comment-author vcard"> <img class="avatar photo"
                                                        src="assets/images/testimonials/pic3.jpg" alt=""> <cite
                                                        class="fn">John Doe</cite> <span class="says">says:</span>
                                                </div>
                                                <div class="comment-meta"> <a href="#">December 02, 2019 at
                                                        10:45 am</a> </div>
                                    ...
                                    <div class="comment-respond" id="respond">
                                        ...
                                        <form class="comment-form" id="commentform" method="post">
                                            ...
                                            <p class="form-submit">
                                                <input type="submit" value="Submit Comment" class="submit" id="submit"
                                                    name="submit">
                                            </p>
                                        </form>
                                    </div>
                    ...
                    <div class="col-lg-4 col-xl-4">
                        <aside class="side-bar sticky-top">
                            ...
                            <div class="widget recent-posts-entry">
                                ...
                                <div class="widget-post-bx">
                                    ...
                                    <div class="widget-post clearfix">
                                        ...
                                        <div class="ttr-post-info">
                                            <div class="ttr-post-header">
                                                <h6 class="post-title"><a href="blog-details.html">What Will
                                                        Education Be Like In The Next 50 Years?</a></h6>
                                            </div>
                                            <ul class="media-post">
                                                <li><a href="#"><i class="fa fa-calendar"></i>May 14 2019</a>
                                                </li>
                                                <li><a href="#"><i class="fa fa-comments-o"></i>23 Comment</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="widget-post clearfix">
                                        ...
                                        <div class="ttr-post-info">
                                            <div class="ttr-post-header">
                                                <h6 class="post-title"><a href="blog-details.html">Eliminate
                                                        Your Fears And Doubts About Education.</a></h6>
                                            </div>
                                            <ul class="media-post">
                                                <li><a href="#"><i class="fa fa-calendar"></i>June 12 2019</a>
                                                </li>
                                                <li><a href="#"><i class="fa fa-comments-o"></i>27 Comment</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="widget widget_gallery gallery-grid-4">
                                ...
                                <ul>
                                    <li>
                                        <div><a href="#"><img src="assets/images/gallery/pic2.jpg" alt=""></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div><a href="#"><img src="assets/images/gallery/pic1.jpg" alt=""></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div><a href="#"><img src="assets/images/gallery/pic5.jpg" alt=""></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div><a href="#"><img src="assets/images/gallery/pic7.jpg" alt=""></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div><a href="#"><img src="assets/images/gallery/pic8.jpg" alt=""></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div><a href="#"><img src="assets/images/gallery/pic9.jpg" alt=""></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div><a href="#"><img src="assets/images/gallery/pic3.jpg" alt=""></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div><a href="#"><img src="assets/images/gallery/pic4.jpg" alt=""></a>
                                        </div>
                                    </li>
                                </ul>
                            </div>
