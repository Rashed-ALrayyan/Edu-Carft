                        ...
                        <ul>
                            ...
                            <li data-index="rs-100" data-transition="parallaxvertical" data-slotamount="default"
                                ...
                                <div class="tp-caption Newspaper-Subtitle   tp-resizeme" id="slide-100-layer-4"
                                    ...
                                    Improve your knowledege, Study from home, get access to courses anytime and earn
                                    real practical skills with our courses.
                                </div>
                                <!-- LAYER NR. 4 -->
                                <a href="about-1.php">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="service-bx">
                                    ...
                                    <div class="info-bx text-center">
                                        ...
                                        <h4><a href="courses.php">Learn Courses Online</a></h4>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="service-bx m-b0">
                                    ...
                                    <div class="info-bx text-center">
                                        ...
                                        <h4><a href="book.php">Book Library & Store</a></h4>
                                        <a href="book.php" class="btn radius-xl">View More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="courses-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                                <?php
require 'pdoconn.php';
$sql = $pdo->prepare("SELECT ct, cd, cdes,img FROM ccard");
    $sql->execute();
    foreach($sql as $res){
                echo ' <div class="item">
                                    <div class="cours-bx">
                ...
                <div class="section-area section-sp2">
                    <div class="container">
                        ...
                        <div class="recent-news-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                            <?php
require 'pdoconn.php';
$sql = $pdo->prepare("SELECT bt, bd, bdes,bimg FROM bcard");
    $sql->execute();
    foreach($sql as $res){
                echo ' <div class="item">
                                <div class="recent-news">
                                    <div class="action-box">
                                        <img src="assets/card/'.$res['bimg'].'" alt="">
                                    </div>
                                    <div class="info-bx">
                                        <ul class="media-post">
                                        ...
                                        <h5 class="post-title"><a href="blog-details.html">'.$res['bt'].'</a></h5>
                                        <p>'.$res['bdes'].'</p>
...
?>
                ...
                <div class="section-area section-sp2 bg-fix ovbl-dark"
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-11 text-white heading-bx left">
                                <h2 class="title-head text-uppercase">what people <span>say</span></h2>
                                <p style="display:inline;">It is a long established fact that a reader will be
                                ...
                                <div id="smodel" style=display:none>
                                    <form method="POST" action="comment.php">
                                        <input type="text" required autocomplete="off" name="comm"
                            ...
                            {
                                echo '  <button type="button" id="model" class="btn btn-primary">
                                    FeedBack
                                </button>';
                            } ?>
                                <script>
                                const box = document.getElementById('smodel');
                        ...
                        <div class="testimonial-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                            ...
                            <?php
require 'pdoconn.php';
$sql = $pdo->prepare("SELECT comment, name,img FROM cmnt");
    $sql->execute();
    foreach($sql as $res){
        ...
        echo ' <div class="item">
                                ...
                                <div class="testimonial-bx">
                                    <div class="testimonial-thumb">
                                        <img src="assets/avatar/'.$res['img'].'.png" alt="">
                                    </div>
                                    <div class="testimonial-info">
                                        <h5 class="name">'.$res['name'].'</h5>
                                    </div>
