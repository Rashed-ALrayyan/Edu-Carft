...
<head>
    ...
    <!-- PAGE TITLE HERE ============================================= -->
    <title>EduChamp | Our Courses </title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-12">
                                <div class="row">
                                    <?php
require 'pdoconn.php';
$sql = $pdo->prepare("SELECT * FROM ccard");
    $sql->execute();

    foreach($sql as $res){
    
        echo '<div class="col-md-6 col-lg-4 col-sm-6 m-b30">
                                        <div class="cours-bx">
                                            <div class="action-box">
                                                <img src="assets/card/'.$res['img'].'.jpg" alt="">
                                    <a href="ctop.php?id='.$res['cid'].'" class="btn">Add Course</a>
                                </div>
                                <div class="info-bx text-center">
                                    <h5><a href="course-details.php">'.$res['ct'].'</a></h5>
